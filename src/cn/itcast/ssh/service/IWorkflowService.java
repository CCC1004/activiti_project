...
public interface IWorkflowService {
	...
	List<ProcessDefinition> findProcessDefinitionListNewVersion();

	List<ProcessDefinition> findProcessDefinitionListByKey(String key);

	void deleteAllPDByKey(String key);
	
	void deletePDById(String deploymentId);

	void deploymentProcessByZip(String deploymentName, File file);
